...
public class FlashLine : MonoBehaviour
{
...

    {
        ...
        /*if (Vector3.Distance(StartPosition.position, EndPostion.position) > 3f)
        {
...

    {
...

        {
            ...
            midX += (float)(Random.Range(0f, 0.5f) - 0.25f) * displace / displacement;

            midY += (float)(Random.Range(0f, 0.5f) - 0.25f) * displace / displacement;
